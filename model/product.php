<?php
    ...
    // Chèn video vào
    function getVideo($id_product)
    {
        $sql="select video from product where id='$id_product'";
        return getone($sql);
    }
    // function countcourses($id_product){
    //     $sql ="select count(video) from product where id='$id_product'";
    //     return getlist($sql);
    // }
