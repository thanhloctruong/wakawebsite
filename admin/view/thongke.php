<nav class="navbar-default navbar-side" role="navigation">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                ...
                <div class="row">
                    <Label style='magin-left: 30px;'>Bắt đầu từ ngày</Label>
                    <input type="date" value='1/6/2021'>
                    <Label>đến ngày</Label>
                    <input type="date" value='5/6/2021'>
                    <a href="?act=thongke">search</a>
                </div>
                <div class="row">
                    <div class="col-2">
                    <div id="test_chart" style="width: 900px; height: 500px; float: left;"></div>
                    </div>
                    <div class="col-2">
