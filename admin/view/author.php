                    ...
                    <tbody>
                        <?php
                                  foreach ($author as $a) {
                                      ...
                                      <td>'.$a['id'].'</td>
                                      <td>'.$a['name'].'</td>
                                      <td><a href="index.php?act=author_del&auid='.$a['id'].'"><i class="fa fa-eraser" style="font-size:24px"></i></a> | <a href="index.php?act=author_edit&auid='.$a['id'].'"><i class="fa fa-edit" style="font-size:24px"></i></a></td>
                                      </tr>
                                      ';
                                  }
                                  ?>
