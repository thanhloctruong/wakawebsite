...
<div id="page-wrapper">
    <div id="page-inner">
        ...
        <a href="index.php?act=teacher_add"><button type="button" class="btn btn-success"><i class="fa fa-plus" style="color:white"></i> thêm giảng viên mới</button></a>
                ...
                <table id="myTable" class="table table-bordered table-dark">
                    <thead style="background-color: rgba(0, 0, 0, 0.3);">
                        <tr>
                            ...
                            <th scope="col" style="text-align: center; width:90px;">----</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php
                                    foreach ($teachers as $u) {
                                        ...
                                        <td>'.$role.'</td>
                                        <td>'.$gender.'</td>
                                        <td style="width:90px;"><a href="index.php?act=teacher_del&id='.$u['id'].'"><i class="fa fa-eraser" style="font-size:24px"></i></a> | <a href="index.php?act=teacher_edit&id='.$u['id'].'"><i class="fa fa-edit" style="font-size:24px"></i></a></td>
                                        </tr>
                                        ';
                                    }
                                    ?>
