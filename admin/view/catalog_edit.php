        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                    <a href="index.php?act=teacher"><i class="fa fa-users"></i>Users</a>
                    </li>
                            ...
                            <table class="table table-bordered table-dark" style="width: 80%; margin: 0 auto;">
                                ...
                                <tbody>
                                  ...
                                  <?php
                                      ...
                                      <tr>
                                      <td><input type="hidden" name="id" id="" value="'.$cat['id'].'">
                                      <input type="text" name="" id="" value="'.$cat['id'].'"></td>
                                      <td><input type="text" name="name" id="" value="'.$cat['name'].'"></td>
                                      <td><input type="number" name="id_paretn" id="" value="'.$cat['id_paretn'].'"></td>
                                      <td><input type="number" name="home" id="" value="'.$cat['home'].'"></td>
                                      <td><input type="number" name="pro" id="" value="'.$cat['pro'].'"></td>
                                      </tr>
