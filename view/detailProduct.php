            ...
            <div class="top-left-wr">
                ...
                <div class="txt-detail">
                    ...
                    <form>
                        ...
                        <button type="submit" name="submit" class="add_cart" ><a href="?act=cart">Mua Khoá Học</a></button>
                        <button type="submit" name="submit" class="add_cart"><a href="?act=learn&id=<?php echo($id) ?>">Học Ngay</a></button>
                        <?php else: ?>
                        <button type="button"><a href="?act=login">Mua Khoá Học</a></button>
                        <button type="button"><a href="?act=login">Học Ngay</a></button>
                        <?php endif; ?>
                    </form>
