...
<div class="content pa">
        <div class="left-siderbar ht900" style="height: 1100px">
            ...
            <!-- <div class="check" id="service">
                <p>Dịch vụ</p>
                <label class="container">Giao hàng miễn phí
                    <input type="checkbox">
                    <span class="checkmark"></span>
                </label>
                <label class="container">Thanh toán khi nhận hàng
                    <input type="checkbox">
                    <span class="checkmark"></span>
                </label>
                <label class="container">Xử lý đơn hàng
                    <input type="checkbox">
                    <span class="checkmark"></span>
                </label>
            </div> -->
            <!-- <div class="check" id="location">
                <p>Địa điểm</p>
<label class="container">Nội Địa
                    <input type="checkbox">
                    <span class="checkmark"></span>
                    </label>
                <label class="container">Nước Ngoài
                    <input type="checkbox">
                    <span class="checkmark"></span>
                </label>
            </div> -->
            ...
            <div class="wrap-header">
                ...
                <div class="filter">
                    ...
                    <select name="" id="price-sort">
                        <option value="0" selected disabled>xem nhiều nhất</option>
                    ...
                    echo '
                        <div class="book">
                            ...
                            <form>
                                ...
                                <button type="button" name="submit" value="Thêm" class="addcart" style="display: none;"><a href="?act=cart"></a> </button>
                            </form>   
                        </div>';
                }
                else {
                    echo '
                        <div class="book">
                            ...
                            <form>
                                ...
                                <input type="hidden" name="img" value="'.$img.'">
                                <button type="button" class="addcart" name="submit" style="display: none;"><a href="?act=login"></a></button>
                            </form>   
                        </div>';
                }
            }
                            ...
                            if(data.length >= 1) {
                                data.forEach(book => {
                                    ...
                                    <form action="index.php?act=viewcart" method="post">
                                        ...
                                        <button type="button" name="submit" value="Thêm" class="addcart"><a href="?act=cart">Thêm</a> </button>
                                    </form>   
                                </div>`);
                                    <?php endif; ?>
                                    <?php if(!isset($_SESSION['id'])): ?>
